# Human Review: definition.acyclic

Artifact: `definition.acyclic`
...
Proceed with `cosheaf artifact promote definition.acyclic` after required validation and gate checks pass. Keep the locator conservative unless a maintainer later verifies an exact PDF preview page.
