# Human Review: definition.tree

Artifact: `definition.tree`
...
Proceed with `cosheaf artifact promote definition.tree` after required validation and gate checks pass. Keep the locator conservative unless a maintainer later verifies an exact PDF preview page.
