# Human Review: definition.vertex

Artifact: `definition.vertex`
...
Proceed with `cosheaf artifact promote definition.vertex` after required validation and gate checks pass.
