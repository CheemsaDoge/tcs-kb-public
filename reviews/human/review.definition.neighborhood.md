# Human Review: definition.neighborhood

Artifact: `definition.neighborhood`
...
Proceed with `cosheaf artifact promote definition.neighborhood` after required validation and gate checks pass. Keep the locator conservative unless a maintainer later verifies an exact PDF preview page.
