# Human Review: definition.degree

Artifact: `definition.degree`
...
Proceed with `cosheaf artifact promote definition.degree` after required validation and gate checks pass. Keep the locator conservative unless a maintainer later verifies an exact PDF preview page.
